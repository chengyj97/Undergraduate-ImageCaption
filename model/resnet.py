...
class resnet(nn.Module):
  def __init__(self, opt, _num_layers=101, _fixed_block=4, pretrained=True):  ### !!!
    super(resnet, self).__init__()
    self._num_layers = _num_layers
    self._fixed_block = _fixed_block
    self.pretrained = pretrained
    self.model_path = opt.res101_path
    ...
    self.cnn_net = nn.Sequential(self.resnet.conv1, self.resnet.bn1, self.resnet.relu, self.resnet.maxpool, \
                self.resnet.layer1, self.resnet.layer2, self.resnet.layer3, self.resnet.layer4)
#    self.cnn_net = nn.Sequential(self.resnet.conv1, self.resnet.bn1, self.resnet.relu, self.resnet.maxpool, \
#                self.resnet.layer1, self.resnet.layer2, self.resnet.layer3, self.resnet.layer4, self.resnet.avgpool)
