...
# -*- coding: utf-8 -*-
"""
Created on Tue Mar 19 16:09:51 2019
...
import utils
from dataloader_hdf2 import DataLoaderHDF
...
class DataLoader(Dataset):
    ...
    def get_similar_img(self, imgid, imgIds):
        ...
        if len(imgIds) <= 10:  ### random when num is small
            ...
            path1 = self.image_dir + self.cocotools_det.loadImgs(int(imgid))[0]['file_name']
            
            path2 = {idx:self.image_train_dir + self.cocotools_det_train.loadImgs(idx)[0]['file_name'] for idx in imgIds}
    ...
    def __getitem__(self, index):
        ...
        #imgid_ = self.get_similar_img(imgid, imgIds)  ### !!! choice of similarity is not good
